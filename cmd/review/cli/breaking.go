...
var breakingManifest = []breakingSurface{
	...
	{"oidc/worker/src/index.ts", "Worker API", "Token exchange endpoint changed; action may behave differently"},
	{"telemetry/worker/src/index.ts", "Telemetry Worker", "Telemetry endpoint schema changed; older CLI versions may fail to send events"},
